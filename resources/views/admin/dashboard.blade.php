            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                    <div class="event-item h-100 p-4">
                        <img class="img-fluid w-100 mb-4" src="{{ asset('assets-admin/img/event-1.jpg') }}"
                            alt="">
                ...
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                    <div class="event-item h-100 p-4">
                        <img class="img-fluid w-100 mb-4" src="{{ asset('assets-admin/img/event-2.jp') }}g"
                            alt="">
                ...
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                    <div class="event-item h-100 p-4">
                        <img class="img-fluid w-100 mb-4" src="{{ asset('assets-admin/img/event-3.jpg') }}"
                            alt="">
        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                    <div class="team-item d-flex h-100 p-4">
                        <div class="team-detail pe-4">
                            <img class="img-fluid mb-4" src="{{ asset('assets-admin/img/team-1.jpg') }}"
                                alt="">
                            <h3>Boris Johnson</h3>
                ...
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                    <div class="team-item d-flex h-100 p-4">
                        <div class="team-detail pe-4">
                            <img class="img-fluid mb-4" src="{{ asset('assets-admin/img/team-2.jpg') }}"
                                alt="">
                            <h3>Donald Pakura</h3>
                ...
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                    <div class="team-item d-flex h-100 p-4">
                        <div class="team-detail pe-4">
                            <img class="img-fluid mb-4" src="{{ asset('assets-admin/img/team-3.jpg') }}"
                                alt="">
                            ...
                            <div class="row g-5 align-items-center">
                                <div class="col-md-6">
                                    <div class="testimonial-img">
                                        <img class="img-fluid"
                                            src="{{ asset('assets-admin/img/testimonial-1.jpg') }}" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
